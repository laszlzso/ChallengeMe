...
class ChallengeCompletionEntryListApiView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        field_object = ChallengeSchedule._meta.get_field('user_id') if challenge_schedule else None
        field_value = field_object.value_from_object(challenge_schedule) if field_object else None
        if field_value and self.request.user.id != field_value:
